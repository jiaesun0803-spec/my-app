...
if st.session_state["view_mode"] == "INPUT":
    ...
    with c3_right:
        ...
        with v_cols[0]:
            ...
            st.markdown(f"<div style='text-align:center; padding:5px; background-color:{k_color}; color:white; border-radius:5px; font-size:0.9em; margin-top:-10px;'><b>KCB: {k_grade}</b></div>", unsafe_allow_html=True)
        with v_cols[1]:
