...
if check_password():
                ...
                if "generated_report" not in st.session_state:
                    with st.status("🚀 제미나이(Gemini)가 가로형 레이아웃으로 완벽한 리포트를 생성 중입니다...", expanded=True) as status:
                        try:
                            ...
                            [작성 규칙 - 절대 엄수!!!]
                            1. 마크다운 사용 금지: 제목이나 강조에 마크다운 기호(##, **, - 등)를 절대 사용하지 마세요.
                            반드시 제공된 HTML 태그만 사용해야 합니다.
                            ...
                            [출력 양식]
                            <h2 class="section-title" style="color:#174EA6; border-bottom:2px solid #174EA6; padding-bottom:8px; margin-top:30px;">1.
                            기업현황분석</h2>
    ...
    # --- [입력 화면 (대시보드)] ---
        ...
        with c3:
            st.text_input("전화번호", key="in_biz_tel", on_change=cb_format_phone, args=("in_biz_tel",))
        ...
        with r1:
            ...
            st.text_input("연락처", key="in_rep_phone", on_change=cb_format_phone, args=("in_rep_phone",))
        ...
        st.markdown("<br>", unsafe_allow_html=True)
        st.success("✅ 세팅 완료! 좌측에 API 키 저장하시고 상단 또는 좌측 버튼을 클릭해 주십시오.")
