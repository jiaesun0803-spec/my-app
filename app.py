...
if st.sidebar.button("📊 AI 기업분석리포트", use_container_width=True, key="side_1"): st.session_state["view_mode"] = "REPORT"; st.rerun()
if st.sidebar.button("💡 AI 정책자금 매칭", use_container_width=True, key="side_2"): st.session_state["view_mode"] = "MATCHING"; st.rerun()
if st.sidebar.button("📝 기관별 융자/사업계획서", use_container_width=True, key="side_3"): st.session_state["view_mode"] = "LOAN_PLAN"; st.rerun()
if st.sidebar.button("📑 AI 사업계획서", use_container_width=True, key="side_4"): st.session_state["view_mode"] = "AI_PLAN"; st.rerun()
